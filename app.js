...
var taskInput=document.getElementById("todo__add__input");//Add a new task.
var addButton=document.querySelector(".todo__btn");//first button
var incompleteTaskHolder=document.getElementById("todo__list__incomplete");//ul of #incompleteTasks
var completedTasksHolder=document.getElementById("todo__list__complete");//completed-tasks
